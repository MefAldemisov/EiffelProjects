...
{
	GTCX
	RTOTC (F963_7148,13418,RTMS_EX_H("English",7,257590376));
}
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 962, Current, 0, 0, 13418);
	RTSA(Dtype(Current));
	RTSC;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 962, Current, 0, 0, 13419);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 962, Current, 0, 0, 13421);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
{
	GTCX
	RTOTC (F963_7153,13423,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
{
	GTCX
	RTOTC (F963_7154,13424,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
{
	GTCX
	RTOTC (F963_7155,13425,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}

void EIF_Minit963 (void)
{
	GTCX
	RTOTS (7148,F963_7148)
	RTOTS (7149,F963_7149)
	RTOTS (7150,F963_7150)
	RTOTS (7151,F963_7151)
	RTOTS (7152,F963_7152)
	RTOTS (7153,F963_7153)
	RTOTS (7154,F963_7154)
	RTOTS (7155,F963_7155)
}
