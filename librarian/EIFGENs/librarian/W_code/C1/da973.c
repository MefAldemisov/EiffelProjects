...
extern EIF_TYPED_VALUE F973_7258(EIF_REFERENCE);
...
EIF_TYPED_VALUE F973_7258 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 972, Current, 0, 0, 13506);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(972, Current, 13506);
	RTIV(Current, RTAL);
	RTHOOK(1);
